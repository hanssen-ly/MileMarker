...
from PyQt5.QtWidgets import QApplication, QDateEdit, QLineEdit, QWidget, QLabel, QPushButton, QVBoxLayout, QHBoxLayout, QMessageBox, QTableWidget, QTableWidgetItem, QHeaderView, QCheckBox
...
class MileMarker(QWidget):
    ...
    # settings
    def settings(self):
        self.setWindowTitle("MileMarker")
        self.resize(800,600)
    # init ui
    def initUI(self):
        ...
        self.sub_row3.addWidget(QLabel("Miles:"))
    ...
    def calculate_calories(self):
        ...
        try:
            ...
            ax.scatter(distances, calories, c=normalized_calories, cmap="magma", label="Data Points")
            ax.set_title("Distance V.S. Calories")
    ...
    def apply_styles(self):
        self.setStyleSheet("""
            ...
            QTableWidget {
                ...
                selection-background-color: #a5b8d6;
            }
        ...
        if self.dark_mode.isChecked():
            ...
            QTableWidget {
                background-color: #2b3a52;
                color: #e6e9ef;
                gridline-color: #445a7c;
                border: 1px solid #445a7c;
                selection-background-color: #3e5c8a;
            }
